...
data = np.genfromtxt('Permalloy_del_10ms_thetaa_-3_V_7_04.log',
                     dtype=None,
                     comments='#',           
                     delimiter='\t')  
...
plt.plot(-1*mediaCampo, mediaInte_normalized,marker='.')#'r*-')
plt.xlabel('H (Oe)')
plt.ylabel('I (AU)')
plt.title(r'$\theta_a=6$')
plt.ylim(-1.1,1.1)
plt.axhline(0, color='dodgerblue')
plt.axvline(0, color='dodgerblue')
plt.savefig('Permalloy_del_10ms_thetaa_-3_V_7_04.png')
plt.show()